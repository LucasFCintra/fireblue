...
async function testSimpleRoute() {
  try {
    ...
    const response = await axios.get('http://26.203.75.236:8687/api/produtos');
    console.log('Rota de produtos funcionando:', response.status);
    
    // Testar rota de terceiros
    const response2 = await axios.get('http://26.203.75.236:8687/api/terceiros');
    console.log('Rota de terceiros funcionando:', response2.status);
    
    // Testar rota de fechamento
    const response3 = await axios.get('http://26.203.75.236:8687/api/fechamentos');
