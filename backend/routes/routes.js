...
const dashboardController = require("../controllers/dashboardController");
 ...
 // Rotas para cortes
 router.post('/cortes', corteController.criarCorte);
 router.get('/cortes', corteController.listarCortes);
 router.get('/cortes/:id', corteController.buscarCorte);
 router.put('/cortes', corteController.atualizarCorte);
 router.delete('/cortes/:id', corteController.deletarCorte);
