...
router.get('/api/fichas/dados-consolidados', fichasController.getDadosConsolidadosPeriodo);
router.get('/api/fichas/recebidos/detalhados-por-banca', fichasController.getRecebidosDetalhadosPorBanca);
router.get('/api/fichas/perdidas/detalhadas-por-banca', fichasController.getPerdidasDetalhadasPorBanca);
router.get('/api/fichas/cortadas/detalhadas-por-banca', fichasController.getCortadasDetalhadasPorBanca);
